...
export function TableSeatPicker({
  ...
  return (
    <div className="relative w-full aspect-[4/3] max-w-sm mx-auto">
      {/* Taula ovalada */}
      <div className="absolute inset-x-[18%] inset-y-[22%] rounded-[50%] bg-gradient-to-br from-team-nos/25 via-primary/10 to-team-ells/25 border-2 border-primary/40 shadow-inner" />
      <div className="absolute inset-x-[24%] inset-y-[28%] rounded-[50%] border border-primary/20" />
